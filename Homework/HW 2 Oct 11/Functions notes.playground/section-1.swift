...
func knockMultipleTimes(knocks: Int) {
    for _ in 1...knocks {
        print(knockknock())
    }
}
...
func tellNameAndAge (name: String, yearOfBirth: Int) -> Int {
    var age = calculateAge(1993)
    return age
}
tellNameAndAge("Scott", yearOfBirth: 1993)
...
replyWhoIsHere("scott", homeCountry: "USA")
